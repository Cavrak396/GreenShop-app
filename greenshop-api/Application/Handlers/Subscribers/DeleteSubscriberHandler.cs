...
{
    public class DeleteSubscriberHandler(ISubscribersRepository subscribersRepository) : IRequestHandler<DeleteSubscriberCommand, Unit>
    {
        private readonly ISubscribersRepository _subscribersRepository = subscribersRepository;

        public async Task<Unit> Handle(DeleteSubscriberCommand request, CancellationToken cancellationToken)
        {
