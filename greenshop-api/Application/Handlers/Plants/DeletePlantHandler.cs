...
{
    public class DeletePlantHandler(IPlantsRepository plantsRepository) : IRequestHandler<DeletePlantCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(DeletePlantCommand request, CancellationToken cancellationToken)
        {
            ...
            await _plantsRepository.DeletePlantAsync(plant!);
            return Unit.Value;
        }
    }
}
